...
if __name__ == '__main__':
    ...
    parser.add_argument("--module", dest="module", help="the name of the module. e.g velodynehdle32, kinect2, kinect1")
    parser.add_argument("--position", dest="position", help="the position of the module relative to the frame name -f, e.g [10, 12, 13]")
    parser.add_argument("--frame", dest="frame", help="the frame to which the static transform will be relative to for the position of the sensor")
    parser.add_argument("--type", dest="type", help="the type of module to install, e.g eth for ethernet, usb for usb, bluetooth for bluetooth")
